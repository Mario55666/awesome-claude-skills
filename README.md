...
- [find-skills](https://github.com/vercel-labs/skills) - Helps Claude discover and install skills from the open agent skills ecosystem via the `npx skills` CLI — searches by keyword, checks the skills.sh leaderboard, verifies install counts and source reputation before recommending, then installs. *By [@vercel-labs](https://github.com/vercel-labs)*
...
- [ObsidianSkills](https://github.com/conorluddy/ObsidianSkills) - Two skills for bridging Obsidian vaults with dev workflows: `obsidian-link` symlinks Claude Code agents/skills/plans into your vault for graph view and Dataview, and `obsidian-github-issue-fetcher` syncs GitHub issues in as browsable, queryable notes. *By [@conorluddy](https://github.com/conorluddy)*
